...
from models import NET_WTConv as NET

def parse_option():

    parser = argparse.ArgumentParser('argument for DNaH-RSIR')
    parser.add_argument('--device', type=str, default='cuda:0',
                        help='Device to use for computation (default: cuda:0)')
    parser.add_argument('--info', type=str, default='DNaH-RSIR',
                        help='name')
    # a:eli  b: k
    ...
    parser.add_argument('--pre_weight', default='.../preweight/resnet50.pth',
                        help='path of pre-training weight of AlexNet')
    parser.add_argument('--root_path', default='.../data/UCMD/',
    ...
    # fix_margin_四元组
    parser.add_argument('--margin', type=float, default=0.5, help='weight of margin (default: 0.5)')
...
def main():
    ...
    net = NET.dahnet(code_length=args.bit, num_classes=args.n_class, feat_size=2048,
    ...
    for epoch in range(args.epochs):
        ...
        for i, (images, labels) in enumerate(trainloader):
            ...
            sim_cls = cls @  cls.T
            sim_cls1 = cls1 @ cls.T
            sim_cls2 = cls2 @ cls2.T
            sim_cls3 = cls3 @ cls3.T
            sim_labels = labels @ labels.T

            cls_loss = (1.0 / 2.0) * cross(sim_cls, sim_labels) + \
                       (1.0 / 6.0) * (cross(sim_cls1, sim_labels) + cross(sim_cls2, sim_labels) + cross(sim_cls3, sim_labels))
        ...
        net.eval()
        save_model = '../Result/model_pth' + args.dataset +str(args.bit)
